...
$route['covid-19-services'] = 'Hildes/covid_19_services';
$route['employer-resources'] = 'Hildes/employer_resources';
$route['contact-us'] = 'Hildes/contact_us';
$route['about-us'] = 'Hildes/about_us';
$route['careers'] = 'Hildes/careers';
$route['privacy'] = 'Hildes/privacy';
$route['terms'] = 'Hildes/terms';
$route['blog'] = 'Hildes/blog';
$route['blog/(:any)'] = 'Hildes/blog_detail/$1';
$route['services'] = 'Hildes/services';
$route['service/(:any)'] = 'Hildes/service/$1';
$route['locations'] = 'Hildes/locations';
$route['location/(:any)'] = 'Hildes/location/$1';
