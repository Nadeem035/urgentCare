      	...
      	<div class="panel">
	        ...
	        <div class="panel-body">
	          <form id="exampleFullForm" autocomplete="off" enctype="multipart/form-data" method="post" action="
	          	<?php
		  		if($mode != 'edit')echo BASEURL."admin/post-feature";
			  	else echo BASEURL."admin/update-feature";
		  		?>">
		  		<?php
	            ...
	            <div class="row row-lg">
					...
					<div class="col-lg-12 form-horizontal">
						<div class="form-group form-material">
							<label class="col-lg-12 col-sm-3 control-label">Feature Icon <small class="badge badge-info">Font Awesome Class Like this </small> <small class="badge badge-info">fa-solid fa-heart-circle-plus</small>
							</label>
							<div class=" col-lg-12 col-sm-9">
								<input type="text" class="form-control" name="feature_icon" placeholder="fa-solid fa-heart-circle-plus" value="<?=$q['feature_icon']?>">
							</div><!-- /12 -->
						</div><!-- /form-group -->
					</div><!-- /form-horizontal -->
