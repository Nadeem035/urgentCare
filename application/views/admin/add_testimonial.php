      	...
      	<div class="panel">
	        ...
	        <div class="panel-body">
	          <form id="exampleFullForm" autocomplete="off" enctype="multipart/form-data" method="post" action="
	          	<?php
		  		if($mode != 'edit')echo BASEURL."admin/post-testimonial";
			  	else echo BASEURL."admin/update-testimonial";
		  		?>">
		  		<?php
	            ...
	            <div class="row row-lg">
					...
					<div class="col-lg-12 form-horizontal">
						<div class="form-group form-material">
							<label class="col-lg-12 col-sm-3 control-label">Age</label>
							<div class=" col-lg-12 col-sm-9">
								<input type="text" class="form-control" name="age" placeholder="Age" value="<?=$q['age']?>">
							</div><!-- /12 -->
						</div><!-- /form-group -->
					</div><!-- /form-horizontal -->
					...
					<div class="col-lg-12 form-horizontal">
		            	<div class="form-group form-material">
							<label class="col-lg-12 col-sm-3 control-label">Comment 
								<span class="required">*</span>
							</label>
							<div class=" col-lg-12 col-sm-9">
								<textarea class="form-control" placeholder="Comment" name="comment" row="10" required><?=$q['comment']?></textarea>
							</div><!-- /12 -->
						</div><!-- /form-group -->
	              	...
	              	<div class="col-lg-12 form-horizontal">
		            	<div class="form-group form-material">
							<label class="col-lg-12 col-sm-3 control-label">Show On Home Page 
								<span class="required">*</span>
							</label>
							<div class=" col-lg-12 col-sm-9">
