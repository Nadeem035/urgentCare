	            ...
	            <div class="row row-lg">
					...
					<div class="col-lg-12 form-horizontal">
						<div class="form-group form-material">
							<label class="col-lg-12 col-sm-3 control-label">Heading
								<span class="required">*</span>
							</label>
							<div class=" col-lg-12 col-sm-9">
								<input type="text" class="form-control" name="heading" placeholder="Heading" required="" value="<?=$q['heading']?>">
							</div><!-- /12 -->
						</div><!-- /form-group -->
					</div><!-- /form-horizontal -->
					...
					<div class="col-lg-12 form-horizontal">
						<div class="form-group form-material">
							...
							<div class=" col-lg-12 col-sm-9">
								<input type="text" class="form-control" name="slider_detail" placeholder="Detail" required="" value="<?=$q['slider_detail']?>">
							</div><!-- /12 -->
						</div><!-- /form-group -->
					</div><!-- /form-horizontal -->
					...
					<div class="col-lg-12 form-horizontal">
						<div class="form-group form-material">
							...
							<div class=" col-lg-12 col-sm-9">
								<input type="number" class="form-control" name="order" placeholder="Order" required="" min="0" value="<?=$q['order']?>">
							</div><!-- /12 -->
						</div><!-- /form-group -->
					</div><!-- /form-horizontal -->
